...
namespace sportstore.Controllers
{
    ...
    public class CustomersController : ControllerBase
    {
        ...
        public CustomersController(SportsContext context)
        {
            _context = context;
        }
        ...
        public List<Customer> GetCustomerById(int id)
       {
            try {
                ...
                using (SqlConnection con = new SqlConnection("Data Source=CAPGEMBDMT34;Initial Catalog=Stores; Integrated Security=True"))
                {
